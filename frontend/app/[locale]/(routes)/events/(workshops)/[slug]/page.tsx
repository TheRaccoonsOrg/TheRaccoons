...
const Workshop2023 = ({ params }: { params: { slug: string } }) => {
  ...
  return (
    <div className="max-w-[924px] mx-auto">
      <h1 className="text-6xl font-raccoons text-hotgreen text-center pt-10">
      ...
      <div className="flex flex-col items-center mt-10">
        <div className="bg-hotgreen rounded-lg w-[629px] h-[349px] bg-opacity-40 flex items-center justify-center border-hotgreen border-2">
          <Image
            className="flex items-center justify-center w-[594px] h-[312px]"
      ...
      <div className="flex flex-row mt-1 ">
        ...
        {filteredWorkshops.moreInfoLink ? (
          <Link className="text-sm underline" href={filteredWorkshops.moreInfoLink}>
            {filteredWorkshops.moreInfoLink}
          </Link>
        ) : null}
      </div>
      ...
      <div className="flex flex-row mt-5 ">
        ...
        <Link className="text-sm underline text-purple-br" href={filteredWorkshops.registerLink}>
